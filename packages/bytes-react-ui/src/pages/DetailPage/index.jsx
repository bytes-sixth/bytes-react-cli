...
const DetailPage = (props) => {
    ...
    const handleName = (value)=>{
        ...
        if(!value){
            props.onNextOne(false);
        }else{
            props.onNextOne(true);
        }
    }
    ...
    return (
        <div className=".detail">
            ...
            <div className="rd-form">
                ...
                >
                    <Form.Item label="项目名称" required>
                        <Input value={projectName} style={{"marginBottom": "12px"}} onChange={(e)=>handleName(e.target.value)} onPressEnter={()=>console.log(projectName)} prefix={<FolderOpenOutlined />} placeholder="输入项目名称" />
                        <Row>
                            <Col span={20}>
                    ...
                    <Form.Item label="更多选项">
                        <Row style={{"marginBottom": "6px"}}>
                            <Col span={20}><h4>若目标文件夹已存在则将其覆盖</h4></Col>
                            <Col span={4} style={{"textAlign":"right"}}>
                                <Switch checked={cover} onChange={e=>setCover(e)} />
                            </Col>
                        </Row>
                        <Row style={{"marginBottom": "6px"}}>
                            <Col span={20}><h4>无新手指引的脚手架项目</h4></Col>
                            <Col span={4} style={{"textAlign":"right"}}>
                    ...
                    <Form.Item label="Git">
                        <Row>
                            <Col span={20}><h4>初始化 Git 仓库（建议）</h4></Col>
                            <Col span={4} style={{"textAlign":"right"}}>
                                <Switch 
                                checked={initGit} 
                                onChange={e=>setInitGit(e)} 
                                />
                            </Col>
                        </Row>
                    </Form.Item>
            ...
            <div className="detail-submit bottom-submit">
                <Button disabled={!projectName} size="large" onClick={handleClick} type="primary" block>下一步</Button>
            </div>
        </div>
    )
}
